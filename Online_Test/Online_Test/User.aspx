...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <asp:Button ID="btn_konu_ekle" runat="server" Text="Konu Ekle" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_konu_ekle" OnClick="btn_konu_ekle_Click" />
        ...
        <div class="modal fade" id="modal_konu_ekle" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <asp:Button ID="btn_konu_ekle_kaydet" runat="server" OnClick="btn_konu_ekle_kaydet_Click" Text="Kaydet" CssClass="btn btn-primary" UseSubmitBehavior="false" />
                    </div>
                </div>
            </div>
